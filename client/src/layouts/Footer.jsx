...
import footerLogo from "../assets/eggy-juicy-burger.svg"
    ...
    <main className='bg-[#100101]'>
      ...
      <section className='flex justify-between h-[159px] items-center'>
        ...
        <div className='flex flex-col md:gap-[25px]'>
          <a href="https://x.com/"><i class='bx bxl-twitter text-white'></i></a>
          <a href="https://www.facebook.com/"><i class='bx bxl-facebook text-white'></i></a>
          <a href="https://www.instagram.com/"><i class='bx bxl-instagram text-white' ></i></a>
          <a href="https://www.youtube.com/"><i class='bx bxl-youtube text-white' ></i></a>
      ...
      <section className='flex justify-between text-[#FBFBFB] py-3'>
        <h6 className='text-[14px] leading-[100%] font-[400]'>TM & Copyright 2025 Eggy's Corporation. All Rights Reserved.</h6>
        <h6 className='text-[14px] leading-[100%] font-[400]'>Privacy Policy</h6>
      </section>
      </footer>
    </main>
